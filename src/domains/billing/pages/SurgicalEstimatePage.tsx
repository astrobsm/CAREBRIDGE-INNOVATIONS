...
export default function SurgicalEstimatePage() {
  ...
  const generatePDF = async () => {
    ...
    doc.text(defaultHospital?.name || 'AstroHEALTH Hospital', pageWidth / 2, y + 14, { align: 'center' });
    ...
    doc.text(
      `Generated by AstroHEALTH EMR | ${defaultHospital?.name || 'Hospital'} | ${format(new Date(), 'dd/MM/yyyy HH:mm')}`,
      pageWidth / 2,
      pageHeight - 5,
      { align: 'center' }
    );
            ...
            >
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]" ref={estimateRef}>
                ...
                <div className="text-center border-b-2 border-primary pb-4 mb-4">
                  ...
                  <p className="text-gray-600">{defaultHospital?.name || 'Hospital'}</p>
                </div>
