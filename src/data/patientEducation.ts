...
export const procedureEducationDatabase: ProcedureEducation[] = [
  ...
  {
    procedureId: 'LIMB-002',
    procedureName: 'Below Knee Amputation (BKA)',
    category: 'Limb Surgery',
    overview: 'A Below Knee Amputation (BKA), also known as a transtibial amputation, is a surgical procedure that removes the lower leg below the knee joint. The knee joint is preserved, which is critically important for future mobility with a prosthetic limb. This surgery is performed when the lower leg is too damaged or diseased to be saved, most commonly due to severe peripheral vascular disease, uncontrolled diabetic gangrene, life-threatening infection, irreparable trauma, or malignant tumors. The goal is to create a well-shaped, pain-free stump (residual limb) that heals well and is suitable for fitting a prosthetic leg.',
    aims: [
      'Remove the non-viable, infected, or diseased portion of the lower limb',
      'Preserve the knee joint to maximize future mobility with a prosthesis',
      'Create a well-padded, cylindrical stump suitable for prosthetic fitting',
      'Control life-threatening infection or gangrene',
      'Relieve intractable pain from ischaemia or tissue necrosis',
      'Prevent sepsis and save the patient\'s life',
    ],
    indications: [
      'Severe peripheral arterial disease (PAD) with non-reconstructable vascular disease and gangrene',
      'Diabetic foot with extensive gangrene or osteomyelitis not amenable to limb salvage',
      'Failed previous foot or ray amputation with progressive tissue loss',
      'Severe crush injury or mangled extremity not suitable for reconstruction',
      'Gas gangrene or necrotizing fasciitis of the lower leg',
      'Malignant bone or soft tissue tumour of the lower leg (e.g., osteosarcoma)',
      'Chronic osteomyelitis with non-functional limb',
      'Frostbite or extensive burns with non-viable tissue',
      'Intractable pain from complex regional pain syndrome (CRPS) as a last resort',
    ],
    anesthesiaTypes: ['spinal', 'general', 'regional'],
    preferredAnesthesia: 'spinal',
    anesthesiaDescription: 'Surgery is typically performed under spinal anaesthesia, which numbs the body from the waist down. This is preferred because many patients have significant cardiovascular comorbidities that make general anaesthesia higher risk. An epidural catheter may be placed for post-operative pain control. General anaesthesia is used when spinal is contraindicated or if the patient prefers.',
    expectedOutcomes: [
      'Complete removal of the diseased or non-viable lower limb segment',
      'Well-healed, pain-free residual limb (stump) within 6-8 weeks',
      'Prosthetic fitting at 6-12 weeks after surgery when stump has matured',
      'Return to independent mobility with prosthesis in 3-6 months',
      'Approximately 60-70% of BKA patients achieve functional prosthetic walking',
      'Preserved knee function for more natural gait with prosthesis vs above-knee amputation',
    ],
    successRate: '75-85% primary wound healing rate; 60-70% achieve independent prosthetic ambulation',
    healingTime: '6-8 weeks for wound healing; 3-6 months for stump maturation and prosthetic rehabilitation',
    hospitalStay: '7-14 days depending on wound healing, infection control, and physiotherapy progress',
    generalComplications: generalSurgicalComplications,
    specificComplications: [
      {
        name: 'Stump Wound Breakdown / Dehiscence',
        description: 'The surgical wound may fail to heal, especially in patients with poor blood supply or diabetes. May require wound care, skin grafting, or revision to a higher level.',
        likelihood: 'common',
        percentage: '10-30%',
        severity: 'major',
      },
      {
        name: 'Stump Infection',
        description: 'Deep or superficial infection of the amputation stump requiring antibiotics or surgical drainage',
        likelihood: 'common',
        percentage: '10-20%',
        severity: 'moderate',
      },
      {
        ...
        description: 'Persistent sensation of pain, tingling, or cramping in the amputated part. Affects most amputees to some degree and may require long-term pain management.',
        likelihood: 'very_common',
        percentage: '50-80%',
        severity: 'moderate',
      },
      {
        ...
        description: 'Non-painful awareness or sensation of the missing limb (itching, warmth, movement). This is normal and usually diminishes over time.',
        likelihood: 'very_common',
        percentage: '80-100%',
        severity: 'minor',
      },
      {
        name: 'Stump Neuroma',
        description: 'Painful nerve ending growth in the stump that may cause shooting pain or hypersensitivity',
        likelihood: 'uncommon',
        percentage: '5-15%',
        severity: 'moderate',
      },
      {
        name: 'Need for Revision or Above-Knee Amputation',
        description: 'If the BKA stump fails to heal, a revision or conversion to above-knee amputation (AKA) may be needed. This occurs in approximately 10-15% of cases.',
        likelihood: 'uncommon',
        percentage: '10-15%',
        severity: 'major',
      },
      {
        ...
        description: 'Tightening of muscles causing the knee to remain bent, which interferes with prosthetic fitting. Prevented by proper positioning and early physiotherapy.',
        likelihood: 'common',
        percentage: '10-20%',
        severity: 'moderate',
      },
      {
        ...
        description: 'Blood clot formation in the remaining leg veins with risk of clot travelling to lungs. Prevented with blood thinning injections and early mobilization.',
        likelihood: 'uncommon',
        percentage: '5-10%',
        severity: 'life_threatening',
      },
      {
        name: 'Contralateral Limb Loss',
        description: 'Patients with vascular disease have a 15-30% risk of needing amputation of the other leg within 5 years',
        likelihood: 'uncommon',
        percentage: '15-30% at 5 years',
        severity: 'major',
      },
      {
        name: 'Cardiovascular Events',
        description: 'Patients requiring BKA often have significant cardiovascular disease; risk of heart attack or stroke in the peri-operative period',
        likelihood: 'uncommon',
        percentage: '5-10%',
        severity: 'life_threatening',
      },
    ...
    lifestyleChanges: [
      {
        category: 'Stump Care',
        recommendation: 'Keep stump clean; wash daily with mild soap and water. Pat dry thoroughly. Inspect for skin breakdown, redness, or sores.',
        duration: 'Permanent',
        importance: 'essential',
      },
      {
        category: 'Stump Positioning',
        recommendation: 'Keep knee straight (extended) when lying down. Do NOT place pillow under knee. Lie prone (face down) for 30 minutes 2-3 times daily to prevent contracture.',
        duration: '8-12 weeks until prosthetic fitting',
        importance: 'essential',
      },
      {
        category: 'Compression & Bandaging',
        recommendation: 'Apply stump bandage/shrinker sock as instructed to shape the stump for prosthetic fitting',
        duration: 'Until prosthesis is fitted (6-12 weeks)',
        importance: 'essential',
      },
      {
        category: 'Physiotherapy & Exercises',
        recommendation: 'Perform daily exercises to strengthen arms, remaining leg, and core. Practice transfers and wheelchair skills. Progress to prosthetic gait training.',
        duration: '3-6 months intensive; ongoing maintenance',
        importance: 'essential',
      },
      {
        category: 'Diabetes Management',
        recommendation: 'Strict blood sugar control (HbA1c < 7%) to promote healing and protect the remaining limb',
        duration: 'Permanent',
        importance: 'essential',
      },
      {
        category: 'Smoking Cessation',
        recommendation: 'Absolutely NO smoking — this is the single most important modifiable risk factor for wound healing and protecting your other leg',
        duration: 'Permanent',
        importance: 'essential',
      },
      {
        category: 'Diet & Nutrition',
        recommendation: 'High-protein diet to promote wound healing. Adequate iron and vitamin C. May need nutritional supplements.',
        duration: 'During healing phase (8-12 weeks minimum)',
        importance: 'essential',
      },
      {
        category: 'Wheelchair & Mobility Aids',
        recommendation: 'Use wheelchair safely; do NOT lean forward without counterweight. Use walking frame/crutches only as instructed.',
        duration: 'Until independent with prosthesis',
        importance: 'essential',
      },
      {
        category: 'Psychological Support',
        recommendation: 'Limb loss causes grief and depression in many patients. Seek support from family, counselors, or amputee support groups.',
        duration: 'Ongoing as needed',
        importance: 'recommended',
      },
      {
        category: 'Remaining Foot Care',
        recommendation: 'Inspect remaining foot DAILY. Never walk barefoot. Wear well-fitting shoes. Report ANY injury or color change immediately.',
        duration: 'Permanent',
        importance: 'essential',
      },
    ],
    patientResponsibilities: [
      {
        phase: 'pre_operative',
        responsibility: 'Optimize blood sugar control — target fasting glucose below 10 mmol/L before surgery',
        importance: 'critical',
      },
      {
        phase: 'pre_operative',
        responsibility: 'Stop smoking immediately — at least 4 weeks before surgery if possible',
        importance: 'critical',
      },
      {
        phase: 'pre_operative',
        responsibility: 'Inform surgeon of ALL medications including blood thinners, herbal/traditional remedies',
        importance: 'critical',
      },
      {
        phase: 'pre_operative',
        responsibility: 'Attend pre-anaesthetic assessment and complete all requested blood tests and investigations',
        importance: 'critical',
      },
      {
        phase: 'immediate_post_op',
        responsibility: 'Keep leg elevated on pillow for first 48 hours to reduce swelling',
        importance: 'critical',
      },
      {
        phase: 'immediate_post_op',
        responsibility: 'Do NOT place pillow under knee — keep knee straight at all times when lying down',
        importance: 'critical',
      },
      {
        phase: 'immediate_post_op',
        responsibility: 'Perform deep breathing exercises every hour to prevent lung complications',
        importance: 'important',
      },
      {
        phase: 'immediate_post_op',
        responsibility: 'Report pain level honestly to ensure adequate pain control',
        importance: 'important',
      },
      {
        phase: 'recovery',
        responsibility: 'Attend ALL physiotherapy sessions — this determines your mobility outcome',
        importance: 'critical',
      },
      {
        phase: 'recovery',
        responsibility: 'Apply stump bandage/shrinker as taught by physiotherapist',
        importance: 'critical',
      },
      {
        phase: 'recovery',
        responsibility: 'Practice lying face down (prone) for 30 minutes 2-3 times daily to prevent knee contracture',
        importance: 'critical',
      },
      {
        phase: 'recovery',
        responsibility: 'Attend wound care appointments and do NOT remove dressings without instruction',
        importance: 'critical',
      },
      {
        phase: 'long_term',
        responsibility: 'Attend prosthetic fitting and rehabilitation appointments',
        importance: 'critical',
      },
      {
        phase: 'long_term',
        responsibility: 'Inspect stump skin daily for breakdown, redness, or sores',
        importance: 'critical',
      },
      {
        phase: 'long_term',
        responsibility: 'Protect remaining foot — inspect daily, never walk barefoot, wear protective footwear',
        importance: 'critical',
      },
      {
        phase: 'long_term',
        responsibility: 'Maintain cardiovascular follow-up and take prescribed medications for blood pressure, cholesterol, diabetes',
        importance: 'critical',
      },
    ],
    followUpSchedule: [
      '3-5 days: First wound inspection and dressing change',
      '10-14 days: Suture/staple removal and wound assessment',
      '3-4 weeks: Wound healing evaluation and early stump shaping',
      '6-8 weeks: Stump maturation assessment and prosthetic referral',
      '3 months: Prosthetic fitting and gait training commencement',
      '6 months: Prosthetic adjustment and rehabilitation progress review',
      '12 months: Annual review — stump, prosthesis, cardiovascular status, remaining limb',
      'Annually thereafter: Long-term follow-up for stump health, prosthetic needs, and vascular status',
    ],
    warningSignsToReport: [
      'Increasing pain, redness, or swelling in the stump',
      'Wound opening or pus discharge from the stump',
      'Fever above 38°C or feeling generally unwell',
      'Foul smell from the wound/dressing',
      'Active bleeding that does not stop with pressure',
      'Darkening or color change of the wound edges',
      'Sudden severe pain, swelling, or redness in the remaining leg (possible DVT)',
      'Chest pain, shortness of breath, or coughing blood (possible pulmonary embolism)',
      'Depression, hopelessness, loss of motivation — seek psychological support',
      'Any injury or color change on the remaining foot',
    ],
    alternativeTreatments: [
      'Vascular bypass surgery or angioplasty (if vessels are reconstructable)',
      'Ray amputation or transmetatarsal amputation (if disease is limited to the foot)',
      'Wound care and antibiotics alone (for limited infections with adequate blood supply)',
      'Hyperbaric oxygen therapy (limited availability in Nigeria; adjunctive only)',
      'Palliative/comfort care (if patient declines surgery or is unfit for anaesthesia)',
    ],
    riskOfNotTreating: 'Untreated gangrene or severe infection of the lower leg will progress. The infection can spread into the bloodstream (sepsis), which is life-threatening. Ischaemic pain will worsen progressively. Without amputation, the risk of septic shock, multi-organ failure, and death is very high. Early amputation gives the best chance of healing, rehabilitation, and return to independent mobility.',
  },
...
const procedureNameToEducationId: Record<string, string> = {
  ...
  'below knee amputation': 'LIMB-002',
  'bka': 'LIMB-002',
  'transtibial amputation': 'LIMB-002',
  'below-knee amputation': 'LIMB-002',
  'lower leg amputation': 'LIMB-002',
  // Tumor surgery
  'lipoma': 'TUMOR-001',
