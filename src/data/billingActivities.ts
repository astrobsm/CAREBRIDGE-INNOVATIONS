...
export const billableActivities: BillableActivity[] = [
  ...
  // ============================================
  // 12. REAL-TIME BILLABLE ACTIVITIES (Per User's Request)
  // ============================================
  {
    id: 'RT-001',
    code: 'RT-CONSULTANT-REVIEW',
    name: 'Consultant Review',
    category: 'doctor_consultation',
    description: 'Daily consultant bedside review of admitted patient',
    minFee: 15000,
    maxFee: 30000,
    defaultFee: 20000,
    duration: '15-30 minutes',
  ...
  {
    id: 'RT-002',
    code: 'RT-DOCTOR-REVIEW',
    name: 'Doctor Review',
    category: 'doctor_consultation',
    description: 'Resident doctor bedside review of admitted patient',
    minFee: 8000,
    maxFee: 15000,
    defaultFee: 12000,
    duration: '10-20 minutes',
  ...
  {
    id: 'RT-003',
    code: 'RT-NURSE-VITALS',
    name: 'Nurse Vitals Recording',
    category: 'nursing_service',
    description: 'Recording and documentation of vital signs',
    minFee: 1500,
    maxFee: 3000,
    defaultFee: 2000,
    duration: '10-15 minutes',
  ...
  {
    id: 'RT-004',
    code: 'RT-TRANSFUSION-RECORD',
    name: 'Blood Transfusion Record',
    category: 'nursing_service',
    description: 'Documentation of blood transfusion chart/record',
    minFee: 800,
    maxFee: 1500,
    defaultFee: 1000,
    duration: '10-15 minutes',
  ...
  {
    id: 'RT-005',
    code: 'RT-MEDICATION-CHART',
    name: 'Medication Chart Record',
    category: 'nursing_service',
    description: 'Medication administration recording on chart (MAR)',
    minFee: 8000,
    maxFee: 15000,
    defaultFee: 10000,
  ...
  },
  {
    ...
    category: 'laboratory',
    description: 'Upload and verification of laboratory results',
    minFee: 300,
    maxFee: 800,
    defaultFee: 500,
  ...
  // ============================================
  // 13. SURGEON ASSISTANT FEES
  // ============================================
  {
    id: 'SA-001',
    code: 'SA-MINOR',
    name: 'Surgeon Assistant - Minor Surgery',
    category: 'procedure',
    description: 'Surgical assistant fee for minor procedures (20% of surgeon fee)',
    minFee: 10000,
    maxFee: 50000,
    defaultFee: 25000,
    duration: 'Per surgery',
    applicableRoles: ['surgeon'],
    notes: 'Calculated as 20% of surgeon fee, credited to assisting surgeon',
  },
  {
    id: 'SA-002',
    code: 'SA-MAJOR',
    name: 'Surgeon Assistant - Major Surgery',
    category: 'procedure',
    description: 'Surgical assistant fee for major procedures (20% of surgeon fee)',
    minFee: 50000,
    maxFee: 200000,
    defaultFee: 100000,
    duration: 'Per surgery',
  ...
  // ============================================
  // 14. ADMINISTRATIVE / MEDICO-LEGAL DOCUMENTATION
  // ============================================
  {
    id: 'ADM-001',
    code: 'ADM-REG',
    name: 'New Patient Registration / File Opening',
    category: 'administrative',
    description: 'Opening of new clinical record / case file (incl. hospital number assignment)',
    minFee: 2000,
    maxFee: 5000,
    defaultFee: 3000,
    duration: '10-15 minutes',
    applicableRoles: ['receptionist', 'medical_records_officer', 'admin'],
    notes: 'Charged once per patient on first registration',
  },
  {
    id: 'ADM-002',
    code: 'ADM-RECORDS',
    name: 'Records Retrieval / Re-registration',
    category: 'administrative',
    description: 'Retrieval of existing case file for follow-up visit',
    minFee: 500,
    maxFee: 1500,
    defaultFee: 1000,
    duration: '5-10 minutes',
    applicableRoles: ['receptionist', 'medical_records_officer'],
    notes: 'Charged per visit when an existing file is pulled',
  },
  {
    id: 'ADM-003',
    code: 'ADM-MED-REPORT',
    name: 'Medical Report (Standard)',
    category: 'administrative',
    description: 'Standard medical report for non-medico-legal purposes (employer, school, travel)',
    minFee: 10000,
    maxFee: 25000,
    defaultFee: 15000,
    duration: '1-2 days turnaround',
    applicableRoles: ['doctor', 'surgeon', 'medical_director'],
    notes: 'Doctor signature required; covers single encounter summary',
  },
  {
    id: 'ADM-004',
    code: 'ADM-MEDICOLEGAL',
    name: 'Medico-legal Report / Police Report',
    category: 'administrative',
    description: 'Detailed medico-legal report for court, insurance or police use',
    minFee: 30000,
    maxFee: 100000,
    defaultFee: 50000,
    duration: '3-7 days turnaround',
    applicableRoles: ['doctor', 'surgeon', 'medical_director'],
    notes: 'Requires consultant sign-off; complexity-dependent fee',
  },
  {
    id: 'ADM-005',
    code: 'ADM-INSURANCE',
    name: 'Insurance / HMO / NHIS Pre-authorisation Form',
    category: 'administrative',
    description: 'Completion of pre-authorisation or claim forms for HMO / NHIS / insurer',
    minFee: 3000,
    maxFee: 10000,
    defaultFee: 5000,
    duration: '15-30 minutes',
    applicableRoles: ['doctor', 'admin', 'medical_records_officer'],
    notes: 'Per form completed and signed',
  },
  {
    id: 'ADM-006',
    code: 'ADM-FITNESS',
    ...
    category: 'administrative',
    description: 'Certificate of medical fitness (employment, sport, travel, school)',
    minFee: 5000,
    maxFee: 15000,
    defaultFee: 8000,
    duration: '20-30 minutes',
    applicableRoles: ['doctor'],
    notes: 'Includes brief examination and documentation',
  },
  {
    id: 'ADM-007',
    code: 'ADM-SICKLEAVE',
    name: 'Sick Leave / Excuse Duty Certificate',
    category: 'administrative',
    description: 'Issuance of sick leave or excuse duty certificate',
    minFee: 1500,
    maxFee: 5000,
    defaultFee: 2500,
    duration: '5-10 minutes',
    applicableRoles: ['doctor'],
    notes: 'Per certificate; covers period of indisposition',
  },
  {
    id: 'ADM-008',
    code: 'ADM-DISCHARGE',
    name: 'Discharge Summary (Patient Copy)',
    category: 'administrative',
    description: 'Issuance of patient/relative copy of discharge summary',
    minFee: 2000,
    maxFee: 5000,
    defaultFee: 3000,
    duration: '15-20 minutes',
    applicableRoles: ['doctor', 'medical_records_officer'],
    notes: 'Photocopy and certification of discharge summary',
  },
  {
    id: 'ADM-009',
    code: 'ADM-DEATH-CERT',
    name: 'Death Certificate / Cause of Death Statement',
    category: 'administrative',
    description: 'Completion of death certificate and medical cause of death',
    minFee: 5000,
    maxFee: 20000,
    defaultFee: 10000,
    duration: '30-45 minutes',
    applicableRoles: ['doctor', 'medical_director'],
    notes: 'Requires doctor who certified death; includes mortuary documentation',
  },
  {
    id: 'ADM-010',
    code: 'ADM-PHOTOCOPY',
    name: 'Photocopy / Duplicate of Medical Records',
    category: 'administrative',
    description: 'Certified photocopy of patient medical records (per page)',
    minFee: 100,
    maxFee: 500,
    defaultFee: 200,
    duration: '5-10 minutes',
    applicableRoles: ['medical_records_officer', 'admin'],
    notes: 'Charged per page; minimum 5-page batch',
  },
  {
    id: 'ADM-011',
    code: 'ADM-REFERRAL',
    name: 'Formal Referral Letter',
    category: 'administrative',
    description: 'Detailed referral letter to another facility / specialist',
    minFee: 3000,
    maxFee: 10000,
    defaultFee: 5000,
    duration: '15-20 minutes',
    applicableRoles: ['doctor', 'surgeon'],
    notes: 'Includes clinical summary and investigation results',
  },
  {
    id: 'ADM-012',
    code: 'ADM-CONSENT-WIT',
    name: 'Witnessed Consent / Independent Counselling',
    category: 'administrative',
    description: 'Independent witnessing of informed consent (high-risk procedures)',
    minFee: 5000,
    maxFee: 15000,
    defaultFee: 8000,
    duration: '20-30 minutes',
    applicableRoles: ['doctor', 'medical_director'],
    notes: 'Required for major surgery, blood transfusion refusal, end-of-life decisions',
  },
];
