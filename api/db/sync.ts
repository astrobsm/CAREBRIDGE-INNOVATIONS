...
async function handleMigrate(res: any) {
  ...
  const columnsToAdd = [
    ...
    { table: 'surgeries', column: 'assistant', definition: 'VARCHAR(255) NULL' },
    { table: 'surgeries', column: 'assistant_id', definition: 'VARCHAR(36) NULL' },
    { table: 'surgeries', column: 'assistant_fee_percentage', definition: 'DECIMAL(5,2) NULL' },
    { table: 'surgeries', column: 'assistant_fee', definition: 'DECIMAL(15,2) NULL' },
    { table: 'surgeries', column: 'anaesthetist', definition: 'VARCHAR(255) NULL' },
    { table: 'surgeries', column: 'anaesthetist_id', definition: 'VARCHAR(36) NULL' },
    { table: 'surgeries', column: 'anaesthesia_fee', definition: 'DECIMAL(15,2) NULL' },
    { table: 'surgeries', column: 'scrub_nurse', definition: 'VARCHAR(255) NULL' },
    { table: 'surgeries', column: 'scrub_nurse_id', definition: 'VARCHAR(36) NULL' },
    { table: 'surgeries', column: 'circulating_nurse', definition: 'VARCHAR(255) NULL' },
    { table: 'surgeries', column: 'circulating_nurse_id', definition: 'VARCHAR(36) NULL' },
    { table: 'surgeries', column: 'surgeon_fee', definition: 'DECIMAL(15,2) NULL' },
    { table: 'surgeries', column: 'blood_loss', definition: 'INT NULL' },
    { table: 'surgeries', column: 'specimen_sent', definition: 'BOOLEAN DEFAULT FALSE' },
    { table: 'surgeries', column: 'specimen_type', definition: 'VARCHAR(255) NULL' },
    { table: 'surgeries', column: 'operative_notes', definition: 'TEXT NULL' },
    { table: 'surgeries', column: 'post_operative_instructions', definition: 'TEXT NULL' },
    { table: 'surgeries', column: 'type', definition: 'VARCHAR(50) NULL' },
    { table: 'surgeries', column: 'category', definition: 'VARCHAR(50) NULL' },
    { table: 'surgeries', column: 'pre_operative_assessment', definition: 'JSON NULL' },
    ...
    { table: 'wounds', column: 'photo_urls', definition: 'JSON NULL' },
    { table: 'wounds', column: 'photos', definition: 'JSON NULL' },
    { table: 'wounds', column: 'encounter_id', definition: 'VARCHAR(36) NULL' },
    { table: 'wounds', column: 'length', definition: 'DECIMAL(8,2) NULL' },
    { table: 'wounds', column: 'width', definition: 'DECIMAL(8,2) NULL' },
    { table: 'wounds', column: 'depth', definition: 'DECIMAL(8,2) NULL' },
    { table: 'wounds', column: 'area', definition: 'DECIMAL(10,2) NULL' },
    { table: 'wounds', column: 'tissue_type', definition: 'JSON NULL' },
    { table: 'wounds', column: 'exudate_amount', definition: 'VARCHAR(50) NULL' },
    { table: 'wounds', column: 'exudate_type', definition: 'VARCHAR(50) NULL' },
    { table: 'wounds', column: 'periwound_condition', definition: 'VARCHAR(255) NULL' },
    { table: 'wounds', column: 'healing_progress', definition: 'VARCHAR(50) NULL' },
    { table: 'wounds', column: 'type', definition: 'VARCHAR(100) NULL' },
    ...
    { table: 'admissions', column: 'created_by', definition: 'VARCHAR(36) NULL' },
    { table: 'admissions', column: 'admitted_by', definition: 'VARCHAR(36) NULL' },
    { table: 'admissions', column: 'admission_number', definition: 'VARCHAR(100) NULL' },
    { table: 'admissions', column: 'admission_time', definition: 'VARCHAR(20) NULL' },
    { table: 'admissions', column: 'admitted_from', definition: 'VARCHAR(100) NULL' },
    { table: 'admissions', column: 'ward_type', definition: 'VARCHAR(100) NULL' },
    { table: 'admissions', column: 'ward_name', definition: 'VARCHAR(255) NULL' },
    { table: 'admissions', column: 'chief_complaint', definition: 'TEXT NULL' },
    { table: 'admissions', column: 'indication_for_admission', definition: 'TEXT NULL' },
    { table: 'admissions', column: 'provisional_diagnosis', definition: 'JSON NULL' },
    { table: 'admissions', column: 'comorbidities', definition: 'JSON NULL' },
    { table: 'admissions', column: 'allergies', definition: 'JSON NULL' },
    { table: 'admissions', column: 'primary_doctor', definition: 'VARCHAR(36) NULL' },
    { table: 'admissions', column: 'primary_nurse', definition: 'VARCHAR(36) NULL' },
    { table: 'admissions', column: 'primary_managing_consultant', definition: 'VARCHAR(36) NULL' },
    { table: 'admissions', column: 'primary_managing_consultant_name', definition: 'VARCHAR(255) NULL' },
    { table: 'admissions', column: 'consultants', definition: 'JSON NULL' },
    { table: 'admissions', column: 'treatment_plan_id', definition: 'VARCHAR(36) NULL' },
    { table: 'admissions', column: 'risk_assessments', definition: 'JSON NULL' },
    { table: 'admissions', column: 'estimated_stay_days', definition: 'INT NULL' },
    { table: 'admissions', column: 'discharge_time', definition: 'VARCHAR(20) NULL' },
    { table: 'admissions', column: 'discharged_by', definition: 'VARCHAR(36) NULL' },
    { table: 'admissions', column: 'discharge_type', definition: 'VARCHAR(100) NULL' },
    { table: 'admissions', column: 'discharge_summary_id', definition: 'VARCHAR(36) NULL' },
    { table: 'admissions', column: 'encounter_id', definition: 'VARCHAR(36) NULL' },
    ...
    { table: 'treatment_progress', column: 'synced_status', definition: "VARCHAR(20) DEFAULT 'pending'" },
    { table: 'treatment_progress', column: 'recorded_at', definition: 'DATETIME NULL' },
    { table: 'treatment_progress', column: 'recorded_by', definition: 'VARCHAR(36) NULL' },
    { table: 'treatment_progress', column: 'observations', definition: 'TEXT NULL' },
    { table: 'treatment_progress', column: 'measurements', definition: 'JSON NULL' },
    { table: 'treatment_progress', column: 'orders_executed', definition: 'JSON NULL' },
    { table: 'treatment_progress', column: 'outcome_assessment', definition: 'TEXT NULL' },
    { table: 'treatment_progress', column: 'clinician_notes', definition: 'TEXT NULL' },
    { table: 'treatment_progress', column: 'photos', definition: 'JSON NULL' },
    
    // investigations table
    { table: 'investigations', column: 'synced_status', definition: "VARCHAR(20) DEFAULT 'pending'" },
    { table: 'investigations', column: 'name', definition: 'VARCHAR(255) NULL' },
    { table: 'investigations', column: 'description', definition: 'TEXT NULL' },
    { table: 'investigations', column: 'type_name', definition: 'VARCHAR(255) NULL' },
    { table: 'investigations', column: 'patient_name', definition: 'VARCHAR(255) NULL' },
    { table: 'investigations', column: 'hospital_number', definition: 'VARCHAR(100) NULL' },
    { table: 'investigations', column: 'hospital_name', definition: 'VARCHAR(255) NULL' },
    { table: 'investigations', column: 'encounter_id', definition: 'VARCHAR(36) NULL' },
    { table: 'investigations', column: 'admission_id', definition: 'VARCHAR(36) NULL' },
    { table: 'investigations', column: 'fasting', definition: 'BOOLEAN DEFAULT FALSE' },
    { table: 'investigations', column: 'clinical_details', definition: 'TEXT NULL' },
    { table: 'investigations', column: 'clinical_info', definition: 'TEXT NULL' },
    { table: 'investigations', column: 'requested_by_name', definition: 'VARCHAR(255) NULL' },
    { table: 'investigations', column: 'collected_at', definition: 'DATETIME NULL' },
    { table: 'investigations', column: 'collected_by', definition: 'VARCHAR(36) NULL' },
    { table: 'investigations', column: 'collected_by_name', definition: 'VARCHAR(255) NULL' },
    { table: 'investigations', column: 'sample_type', definition: 'VARCHAR(100) NULL' },
    { table: 'investigations', column: 'sample_id', definition: 'VARCHAR(100) NULL' },
    { table: 'investigations', column: 'reporting_lab', definition: 'VARCHAR(255) NULL' },
    { table: 'investigations', column: 'reported_at', definition: 'DATETIME NULL' },
    { table: 'investigations', column: 'reported_by', definition: 'VARCHAR(36) NULL' },
    { table: 'investigations', column: 'reported_by_name', definition: 'VARCHAR(255) NULL' },
    { table: 'investigations', column: 'verified_at', definition: 'DATETIME NULL' },
    { table: 'investigations', column: 'verified_by', definition: 'VARCHAR(36) NULL' },
    { table: 'investigations', column: 'verified_by_name', definition: 'VARCHAR(255) NULL' },
    { table: 'investigations', column: 'result_summary', definition: 'TEXT NULL' },
    { table: 'investigations', column: 'result_details', definition: 'JSON NULL' },
    { table: 'investigations', column: 'abnormal_flags', definition: 'JSON NULL' },
    { table: 'investigations', column: 'critical_values', definition: 'JSON NULL' },
    { table: 'investigations', column: 'interpretation', definition: 'TEXT NULL' },
    { table: 'investigations', column: 'recommendations', definition: 'TEXT NULL' },
    { table: 'investigations', column: 'attachments', definition: 'JSON NULL' },
    
    // video_conferences table
    { table: 'video_conferences', column: 'synced_status', definition: "VARCHAR(20) DEFAULT 'pending'" },
    { table: 'video_conferences', column: 'room_code', definition: 'VARCHAR(100) NULL' },
    { table: 'video_conferences', column: 'settings', definition: 'JSON NULL' },
    { table: 'video_conferences', column: 'presentation', definition: 'JSON NULL' },
    { table: 'video_conferences', column: 'recordings', definition: 'JSON NULL' },
    { table: 'video_conferences', column: 'chat_enabled', definition: 'BOOLEAN DEFAULT TRUE' },
    { table: 'video_conferences', column: 'chat_messages', definition: 'JSON NULL' },
    { table: 'video_conferences', column: 'invited_users', definition: 'JSON NULL' },
    { table: 'video_conferences', column: 'actual_start', definition: 'DATETIME NULL' },
    { table: 'video_conferences', column: 'actual_end', definition: 'DATETIME NULL' },
    
    // appointments table
    { table: 'appointments', column: 'synced_status', definition: "VARCHAR(20) DEFAULT 'pending'" },
    { table: 'appointments', column: 'appointment_date', definition: 'DATE NULL' },
    { table: 'appointments', column: 'appointment_time', definition: 'VARCHAR(20) NULL' },
    { table: 'appointments', column: 'start_time', definition: 'VARCHAR(20) NULL' },
    { table: 'appointments', column: 'end_time', definition: 'VARCHAR(20) NULL' },
    { table: 'appointments', column: 'patient_phone', definition: 'VARCHAR(50) NULL' },
    { table: 'appointments', column: 'patient_email', definition: 'VARCHAR(255) NULL' },
    { table: 'appointments', column: 'clinician_name', definition: 'VARCHAR(255) NULL' },
    { table: 'appointments', column: 'outcome_notes', definition: 'TEXT NULL' },
    { table: 'appointments', column: 'checked_in_at', definition: 'DATETIME NULL' },
    { table: 'appointments', column: 'seen_at', definition: 'DATETIME NULL' },
    { table: 'appointments', column: 'completed_at', definition: 'DATETIME NULL' },
    { table: 'appointments', column: 'booked_at', definition: 'DATETIME NULL' },
    { table: 'appointments', column: 'booked_by', definition: 'VARCHAR(36) NULL' },
    { table: 'appointments', column: 'sync_status', definition: "VARCHAR(50) DEFAULT 'pending'" },
    
    // appointment_reminders table
    { table: 'appointment_reminders', column: 'synced_status', definition: "VARCHAR(20) DEFAULT 'pending'" },
    { table: 'appointment_reminders', column: 'whatsapp_message_id', definition: 'VARCHAR(255) NULL' },
    { table: 'appointment_reminders', column: 'whats_app_number', definition: 'VARCHAR(50) NULL' },
    { table: 'appointment_reminders', column: 'message_template', definition: 'VARCHAR(100) NULL' },
    { table: 'appointment_reminders', column: 'message_content', definition: 'TEXT NULL' },
    { table: 'appointment_reminders', column: 'patient_response', definition: 'TEXT NULL' },
    { table: 'appointment_reminders', column: 'response_received_at', definition: 'DATETIME NULL' },
    { table: 'appointment_reminders', column: 'failure_reason', definition: 'TEXT NULL' },
    { table: 'appointment_reminders', column: 'retry_count', definition: 'INT DEFAULT 0' },
    { table: 'appointment_reminders', column: 'max_retries', definition: 'INT DEFAULT 3' },
    { table: 'appointment_reminders', column: 'scheduled_for', definition: 'DATETIME NULL' },
    { table: 'appointment_reminders', column: 'sent_at', definition: 'DATETIME NULL' },
    { table: 'appointment_reminders', column: 'delivered_at', definition: 'DATETIME NULL' },
    { table: 'appointment_reminders', column: 'channel', definition: 'VARCHAR(50) NULL' },
